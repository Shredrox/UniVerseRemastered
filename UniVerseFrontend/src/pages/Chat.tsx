...
import useMessagesData from '../hooks/query/useMessagesData';
...
const Chat = () => {
  ...
  const { messages, 
    ...
    messagesError,
    sendMessageMutation
  } = useMessagesData(auth?.username, username);
  ...
  const handleMessageSent = () =>{
    ...
    sendMessageMutation({message: message, sender: auth?.username, receiver: username});
    setMessage('');
  }
    ...
    <div className='chat'>
      ...
      <div className='chat-messages-container' ref={chatRef}>
        ...
        messages?.map((message, index) =>
          <div key={index} className={message.sender === auth?.username ? 'your-chat-message-container' : 'chat-message-container'}>
            <div  className={message.sender === auth?.username ? 'your-chat-message' : 'chat-message'}>
