        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupEvents_Organisers_OrganiserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobOfferUser", x => new { x.ApplicantsId, x.JobOffersId });
                    table.ForeignKey(
                        name: "FK_JobOfferUser_AspNetUsers_ApplicantsId",
                        column: x => x.ApplicantsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobOfferUser_JobOffers_JobOffersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupEventsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupEventUser", x => new { x.AttendeesId, x.GroupEventsId });
                    table.ForeignKey(
                        name: "FK_GroupEventUser_AspNetUsers_AttendeesId",
                        column: x => x.AttendeesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupEventUser_GroupEvents_GroupEventsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupEventUser_GroupEventsId",
                table: "GroupEventUser",
                column: "GroupEventsId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupEvents_OrganiserId",
                table: "GroupEvents",
                column: "OrganiserId");

            migrationBuilder.CreateIndex(
                name: "IX_JobOfferUser_JobOffersId",
                table: "JobOfferUser",
                column: "JobOffersId");
